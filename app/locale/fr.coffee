...
#    being_reviewed_2: "reviewed."
     approved_1: "Votre demande pour une inscription à un essai gratuit a été"
     approved_2: "approuvé."
...
#    description_4: "Please fill out this quick survey and we’ll email you setup instructions."
    ...
    location: "Nom de la ville"
     ...
     fill_fields: "Veuilez remplir tous les champs."
     thanks: "Merci! Nous allons rapidement vous envoyer les informations de configuration."
...
#    owner_approve: "An owner will need to approve it before your changes will become visible."
  ...
  account_settings:
    ...
    type_in_password: "Rentre aussi ton mot de passe."
  ...
  keyboard_shortcuts:
    ...
    skip_scripts: "Passer tous les scripts passables."
    toggle_playback: "Basculer entre lecture/pause."
    scrub_playback: "Annuler avant et après à travers le temps."
    single_scrub_playback: "Annuler avant et après à travers le temps dans une seule frame."
    scrub_execution: "Annulerl'exécution du sort actuel."
  ...
  community:
    ...
    social_github: "Regardez notre code complet sur Github"
  ...
  clans:
    ...
    leagues_explanation: "Jouer dans une ligue contre des membres d'autres clans dans ces instance d'arènes multijoueurs."

    courses:
     course: "cours"
     courses: "cours"
     not_enrolled: "Vous n'êtes pas inscrit à ce cours."
     visit_pref: "Veuillez visiter"
     visit_suf: "page non enregistrée."
     select_class: "Sélectionnez une de vos classe."
     unnamed: "*Non nommée*"
     select: "Select"
     unnamed_class: "Classe non-nommée"
     edit_settings: "editer les paramètres de la class"
     edit_settings1: "editer les paramètres de la Class"
     progress: "Progression de la Class"
     add_students: "Ajouter étudiants"
     stats: "Statistiques"
     total_students: "Total d'étudiants:"
     average_time: "Temps moyen de jeu pour le niveau:"
     total_time: "Total temps joué:"
     average_levels: "Moyenne des niveaux complétés :"
     total_levels: "Total des niveaux complétés:"
     furthest_level: "Niveau le plus avancé terminé:"
     concepts_covered: "Concepts abordés"
     students: "Etudiants"
     students1: "etudiants"
     expand_details: "Plus de détails"
     concepts: "Concepts"
     levels: "niveaux"
     played: "joué"
     play_time: "Temps joué:"
     completed: "Complété:"
     invite_students: "Inviter des étudiants à rejoindre le cours."
     invite_link_header: "Lien pour rejoindre le cours"
     invite_link_p_1: "Envoie ce lien aux étudiants que tu veux voir rejoindre ce cours."
     invite_link_p_2: "Ou envoie leur directement un mail:"
     capacity_used: "Slot de cours utilisés:"
     enter_emails: "Entrer les mails des étudiants pour les inviter, un mail par ligne"
     send_invites: "Envoyer des invitations"
     title: "titre"
     description: "Description"
     languages_available: "Selectionne un langage de programmation disponible pour la classe:"
     all_lang: "Tous les langages"
     show_progress: "Montrer à tout le monde la progression des étudiants dans la classe"
     creating_class: "Création de la classe..."
     purchasing_course: "Achat d'un cours..."
     buy_course: "Acheter un cours"
     buy_course1: "Acheter ce cours"
     create_class: "Créer une classe"
     select_all_courses: "Séléctionne 'Tous les cours' pour une remise de 50%!"
     all_courses: "Tous les cours"
     number_students: "Nombre d'étudiants"
     enter_number_students: "Entre le nombre d'étudiants dont tu as besoin pour cette classe."
     name_class: "Donne un nom à ta classe"
     displayed_course_page: "Cela va afficher la page du cours pour vous et vos élèves. Vous pouvez changer cela plus tard."
     buy: "Acheter"
     purchasing_for: "Vous avez acheté une license pour "
     creating_for: "Vous avez crée une classe pour "
     for: "pour" # Like in 'for 30 students'
     receive_code: "Vous allez recevoir un code à distribuer à vos étudients, qu'ils peuvent utiliser pour s'inscrire à vos cours."
     free_trial: "Essai gratuit pour les professeurs!"
     get_access: "obtenir un accès individuel à tous les cours pour des besoins d'évaluations."
     questions: "Questions?"
     faq: "FAQ du cours"
     question: "Q:" # Like in 'Question'
     question1: "Quelle est la différence entre ces cours et le jeu solo?"
     answer: "A:" # Like in 'Answer'
     answer1: "Le jeu 1 seul joueur sont conçus de manière individuelles, alors que les cours sont conçus pour les classes."
     answer2: "Le jeu 1 joueur possède des items, des gemmes, une sélection d'héros, un principe de montée de niveaux, et des achats dans le jeu. Cours disposent de fonctionnalités de gestion de classe and a simplifié le niveau, en s'axant sur le rythme des étudiants."
     teachers_click: "Professeurs, cliquez ici"
     students_click: "Etudiants, cliquez ici"
     courses_on_coco: "Cours sur CodeCombat"
     designed_to: "Les cours sont conçus pour introduire le concept des science de l'ordinateur en utilisant l'amusement de CodeCombat et l'environnement engagé. Les niveaux de Code COmbat sont organisés autour de sujets clés pour encourager l'apprentissage progressif, avec des cours de plus de 5 hours."
     more_in_less: "Apprendre plus en moins de temps"
     no_experience: "PAs d'expérience en programmation nécessaire"
     easy_monitor: "Surveiller facilement les progrès des étudiants"
     purchase_for_class: "Acheter des cours pour toute la classe. C'est facile d'inscrire vos étudiants!"
     see_the: "Voir"
     more_info: "pour plus d'informations."
     choose_course: "Choisissez votre cours:"
     enter_code: "Entrer un code pour rejoindre une classe existante"
     enter_code1: "Entrer un code"
     enroll: "S'inscrire"
     pick_from_classes: "Choisissez parmi vos cours actuels"
     enter: "Entrer"
     or: "Ou"
     topics: "Sujets"
     hours_content: "DEs heures de contenu:"
     get_free: "Obtenir des cours GRATUITS"
  ...
  editor:
   ...
   add_system_title: "Ajouter un système au niveau"
  ...
  ladder:
    ...
    simulation_explanation_leagues: "Vous allez principalement aider les jeux simulés pour les joueurs alliés dans vos clans et vos classes."
    ...
    games_in_queue: "Jeux actuellement dans la file d'attente:"
    ...
    watch_battle: "Voir la batailles"
    ...
    tournament_blurb_ace_of_coders: "La bataille est terminée dans le glacier gelé pour ce match de domination en miroir! Le tournoi débutera le Mercredi 16 September jusqu'au Mercredi 14 Octobre 5h pm. Voir les détails."
    ...
    blue_ai: "Bleue AI"
    wins: "Victoire" # At end of multiplayer match playback
  ...
  account_invoices:
   ...
   account_prepaid:
    purchase_code: "Achetez un code d'abonnement"
    purchase_amount: "Montant"
    purchase_total: "Total"
    purchase_button: "Valider l'achat"
    your_codes: "YVos codes:"
  ...
  concepts:
    ...
    classes: "Classes"
    continue_statements: "Continuer l'état"
...
#  temp:
    ace_of_coders_tournament: "Nouveauté: jouer maintenant dans le tournois 'As des codeurs' !"
  ...
  ladder_prizes:
    ...
    custom_avatar: "Avatar CodeCombat personnalisé"
     heap: "pour 6 mois \"Startup\" d'accès"
    credits: "Crédits"
  ...
  employers:
    ...
    hire_developers_not_credentials: "Engager des développeurs, pas des références." # We are not actively recruiting right now, so there's no need to add new translations for the rest of this section.
    ...
    filter_experience_recent_grad: "Grade récent"
